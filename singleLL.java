/* - Programmer: Dean Serrano
 ...
 - Purpose: This program can take in a .txt file with a series of integers to be placed in a single linked list. There is functionality to insert, delete,
    and reead the created list.
